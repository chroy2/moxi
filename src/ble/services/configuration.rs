...
pub struct ThingyConfigurationService {
    #[characteristic(uuid = TCS_DEVICE_NAME, read, write, value = *b"Moxi\0\0")]
    device_name: [u8; 6],
    ...
    #[characteristic(uuid = TCS_BEACON_DATA, read, write, value = *b"\x03goo.gl/pIWdir")]
    beacon_data: [u8; 14],
    ...
    mtu: [u8; 3],
    #[characteristic(uuid = TCS_NFC, read, write, value = *b"nordicsemi.com/thingy\0")]
    nfc: [u8; 22],
}
